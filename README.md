...
* In the folder [GTphic](https://github.com/g95g95/Exam), the histograms of the method graphic are stored. They're probably the fanciest way to show this kind of results. Here below I show an example of how the histogram confrontating our simulated results with real assigned seats looks like (always for 2018 Italian General Elections).
